...
ActiveRecord::Schema[7.1].define(version: 2026_03_31_230000) do
  ...
  create_table "contacts", id: :serial, force: :cascade do |t|
    ...
    t.bigint "company_id"
    t.integer "lead_stage", default: 0, null: false
    t.decimal "deal_value", precision: 12, scale: 2
    ...
    t.index ["account_id", "lead_stage"], name: "index_contacts_on_account_id_and_lead_stage"
    ...
    t.index ["last_contacted_at"], name: "index_contacts_on_last_contacted_at"
  ...
  create_table "conversations", id: :serial, force: :cascade do |t|
    ...
    t.integer "deal_stage", default: 0, null: false
    t.decimal "deal_value", precision: 12, scale: 2
    t.datetime "next_follow_up_at"
    t.datetime "last_contacted_at"
    t.string "deal_currency", default: "CLP", null: false
    t.decimal "deal_value_clp", precision: 12, scale: 2
    t.decimal "fx_rate_usd_clp", precision: 12, scale: 4
    t.string "lost_reason"
    t.index ["account_id", "deal_stage"], name: "index_conversations_on_account_id_and_deal_stage"
    t.index ["account_id", "display_id"], name: "index_conversations_on_account_id_and_display_id", unique: true
    t.index ["account_id", "id"], name: "index_conversations_on_id_and_account_id"
    t.index ["account_id", "inbox_id", "status", "assignee_id"], name: "conv_acid_inbid_stat_asgnid_idx"
    t.index ["account_id", "lost_reason"], name: "index_conversations_on_account_id_and_lost_reason"
    ...
    t.index ["last_contacted_at"], name: "index_conversations_on_last_contacted_at"
    t.index ["next_follow_up_at"], name: "index_conversations_on_next_follow_up_at"
